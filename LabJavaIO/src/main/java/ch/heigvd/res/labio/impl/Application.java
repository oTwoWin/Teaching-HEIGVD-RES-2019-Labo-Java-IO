...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        // create the file path with tags
        ...
        try {
            ...
            // create the directories if necessary and create the file
            file.getParentFile().mkdirs();
            file.createNewFile();
            // try to write on it with UTF-8 charset
            Writer fstream = null;
            ...
            // write the quote
            fstream.write(quote.getQuote());
            // close the file
            fstream.close();
        }catch (Exception e){
            throw new IOException("An error occured when trying to create the file");
        }
    }
